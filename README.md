...
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ✅ #494 | ✅ `5b16bc9` | ✅ 198/198 | ⬜ | ⬜ | ⬜ | ⬜ | 2/5 — verify-abec 통합 빌드 ✓(09-22). OSSCA 등록 → 업로드 허가 대기 (XS) |
| [495852034](https://crbug.com/495852034) B `kRejectInvalidChildRegions` (viz hit_test) | ✅ 09-21 | ✅ #495 | ✅ `2480f86` | ✅ 19/19 | ⬜ | ⬜ | ⬜ | ⬜ | 2/5 — verify-abec 통합 빌드 ✓(09-22). OSSCA 등록 → 업로드 허가 대기 (XS) |
