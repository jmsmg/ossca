...
| [524822746](https://crbug.com/524822746) E `kValidatePromiseImageFormat` (viz display_embedder) | ✅ 09-21 | ⬜ 초안 | ✅ `0738586` | ✅ 19/19 | ⬜ | ⬜ | ⬜ | ⬜ | 2/5 — verify-abec 통합 빌드 ✓(09-22). OSSCA 등록 → 업로드 허가 대기 (XS) |
| (자체 발굴) C gaia 패스키 URL 플래그 (google_apis/gaia) | ✅ 09-21 | ⬜ 초안 | ✅ `16e163c` | ✅ 20/20 | ⬜ | ⬜ | ⬜ | ⬜ | 2/5 — verify-abec 통합 빌드 ✓(09-22). OSSCA 등록 → 업로드 허가 대기 (XS) |
