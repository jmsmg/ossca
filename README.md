...
| [432367602](https://crbug.com/432367602) dropped-frame 플래그 (media/base + blink mediastream) | ✅ 09-18 | ✅ #464 | ✅ `ee435a2` | ✅ 14/14 | ✅ 8429522 | ⏳ | ✅ #475 | ⬜ | 6 — **Mac** 09-18 **CL 8429522** PS1 (kron@·mfoltz@). #464 코멘트 허가 대기 (S) |
...
| [474398415](https://crbug.com/474398415) WebCodecs flush 킬스위치 (media/base + blink webcodecs) | ✅ 09-21 | ✅ #478 | ✅ `607ea05` | ✅ 24/24 | ✅ 8423462 | ⏳ | ⬜ | ⬜ | 6 — **Mac** 09-21 **CL 8423462** PS1 (eugene@ 1차, CC amoseui@). +1 오면 tguilbert@ 추가. #478 코멘트 09-21 · 기록 PR 허가 대기 (S) |
