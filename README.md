...
| [467555325](https://crbug.com/467555325) J `kAccurateVideoFrameConverterColorSpace` (media/base) | ✅ 09-24 | ⬜ 초안 | ✅ `d59604f` | ✅ 1460/1460 | ✅ 8457722 | ⏳ | ⬜ | ⬜ | 6 — **업로드 09-24** (dalecurtis@ 1차 · CC amoseui@). OSSCA 등록 대기 (S) |
| [496016840](https://crbug.com/496016840) G `kWebviewScriptFileOriginCheck` (extensions webview) | ✅ 09-23 | ✅ #517 | ✅ `871237c` | ✅ CF 2/2 | ✅ 8453023 | ⏳ | ⬜ | ⬜ | 6 — mcnee@ **+1**(«LGTM», 09-24) → **creis@ 추가·댓글 09-24 13:56 KST**(사용자), attention creis@ · 기록 PR 미제출 |
