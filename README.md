...
| [496016840](https://crbug.com/496016840) G `kWebviewScriptFileOriginCheck` (extensions webview) | ✅ 09-23 | ✅ #517 | ✅ `871237c` | ✅ CF 2/2 | ✅ 8453023 | ⏳ | ⬜ | ⬜ | 6 — mcnee@ **+1**(«LGTM», 09-24) → 두 번째 커미터 creis@(원 CL 리뷰어) 추가 필요 · 기록 PR 미제출 |
| [489205993](https://crbug.com/489205993) H `kBackgroundActorTaskPopupsOpenInBackground` (chrome/ui actor) | ✅ 09-23 | ✅ #518 | ✅ | ✅ 6/6 | ✅ 8453762 | ⏳ | ⬜ | ⬜ | 6 — tluk@ **+1**(09-24) → 두 번째 mcnee@(원 작성자, actor OWNER) 추가 필요 · 기록 PR 미제출 |
...
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ✅ #494 | ✅ `5b16bc9` | ✅ 198/198 | ✅ 8449690 | ⏳ | ✅ #503 머지 | ⬜ | 6 — tmathmeyer@·dalecurtis@ **+1 둘**, dalecurtis@ CQ+2 → **CQ 실패(09-24 07:30 KST)** gpu-fyi-cq-mac-arm64 WebGL2 conformance 4건(패치 없이 통과, MSE 와 무관) → 재시도 요청 댓글(사용자) · 기록 PR #503 머지 |
