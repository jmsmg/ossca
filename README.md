...
| [524822746](https://crbug.com/524822746) E `kValidatePromiseImageFormat` (viz display_embedder) | ✅ 09-21 | ✅ #497 | ✅ `0738586` | ✅ 19/19 | ✅ 8450690 | ✅ 머지 09-24 | ✅ #507 | ⬜ | 8 — **머지 09-24 03:19 KST** (`faf118a8c89fb`, kylechar@ CQ 재시도). merged PR 로컬 준비 · #497 닫기 대기 |
| (자체 발굴) C gaia 패스키 URL 플래그 (google_apis/gaia) | ✅ 09-21 | ✅ #498 | ✅ `16e163c` | ✅ 20/20 | ✅ 8447532 | ✅ 머지 09-24 | ✅ #508 | ⬜ | 8 — **머지 09-24 03:49 KST** (`ec8311ae05c34`, alexilin@ CQ). merged PR 로컬 준비 · #498 닫기 대기 |
