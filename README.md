...
| 545843242 | ✅ | ✅ | ✅ | ✅ | ✅ 8449730 | ⏳ | ✅ | ➖ | 6 — 8349386 **abandon**(09-22, 스펙 근거 없음; abandoned PR #490) → 후속 WPT 수정 **8449730 업로드(09-23)**, smcgruer@ 1차 · CC amoseui@. run_wpt_tests -p chrome 9/9 |
...
| (자체 발굴) quota 테스트 클럭 댕글링 | ✅ 09-10 | ✅ #421 | ✅ | ✅ | ✅ 8377022 | ✅ 머지 09-23 | ✅ #424 | 🔄 | 8 — **머지 09-23 07:56 KST** (`b8c9f8a3cd8d9`). merged PR **#493**(멘토 대기) · **#421 닫음(09-23 13:00)** |
| (자체 발굴) quota 만료 M148 153곳 | ✅ 09-09 | ✅ #422 | ✅ | ✅ 313/313 | ✅ 8377550 | ✅ 머지 09-21 | ✅ #425 | 🔄 | 8 — **머지 09-21** (`2d9fea1150857`, stevebe@ CQ). merged PR **#487**(09-22) · #422 닫음(09-22) |
...
| [474398415](https://crbug.com/474398415) WebCodecs flush 킬스위치 (media/base + blink webcodecs) | ✅ 09-21 | ✅ #478 | ✅ `607ea05` | ✅ 24/24 | ✅ 8423462 | ✅ 머지 09-22 | ✅ #480 | 🔄 | 8 — **머지 09-22** (`1e1052fd23521`, eugene@ CQ). 기록 PR #480 머지 · merged PR **#491**(멘토 대기) · **#478 닫음(09-23 13:00)** |
| [380105415](https://crbug.com/380105415) LCPP initiator-origin 킬스위치 (chrome/browser/predictors) | ✅ 09-21 | ✅ #496 | ✅ `04c9cdc` | ✅ 127/127 | ⬜ | ⬜ | ⬜ | ⬜ | 2/5 — unit_tests 2h04m ✓(09-22). OSSCA #496 등록(09-23) → 업로드 허가 대기. 리뷰어 chikamune@ → alexilin@ (XS) |
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ✅ #494 | ✅ `5b16bc9` | ✅ 198/198 | ✅ 8449690 | ⏳ | ⬜ | ⬜ | 6 — **업로드 09-23** (PS1, tmathmeyer@ 1차 · CC amoseui@). +1 오면 두 번째 media OWNER (XS) |
| [495852034](https://crbug.com/495852034) B `kRejectInvalidChildRegions` (viz hit_test) | ✅ 09-21 | ✅ #495 | ✅ `2480f86` | ✅ 19/19 | ✅ 8449710 | ⏳ | ⬜ | ⬜ | 6 — **업로드 09-23** (PS1, jonross@ 1차 · CC amoseui@). +1 오면 두 번째 viz OWNER (XS) |
| [524822746](https://crbug.com/524822746) E `kValidatePromiseImageFormat` (viz display_embedder) | ✅ 09-21 | ✅ #497 | ✅ `0738586` | ✅ 19/19 | ⬜ | ⬜ | ⬜ | ⬜ | 2/5 — verify-abec 통합 빌드 ✓(09-22). OSSCA #497 등록(09-23) → 업로드 허가 대기 (XS) |
| (자체 발굴) C gaia 패스키 URL 플래그 (google_apis/gaia) | ✅ 09-21 | ✅ #498 | ✅ `16e163c` | ✅ 20/20 | ⬜ | ⬜ | ⬜ | ⬜ | 2/5 — verify-abec 통합 빌드 ✓(09-22). OSSCA #498 등록(09-23) → 업로드 허가 대기 (XS) |
