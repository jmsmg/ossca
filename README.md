...
| 545843242 | ✅ | ✅ | ✅ | ✅ | ✅ 8449730 | ⏳ | ✅ | ➖ | 6 — 8349386 **abandon**(09-22, 스펙 근거 없음; abandoned PR #490) → 후속 WPT 수정 **8449730 업로드(09-23)**, 기록 PR **#505**, smcgruer@ 1차 · CC amoseui@. run_wpt_tests -p chrome 9/9 |
...
| [380105415](https://crbug.com/380105415) LCPP initiator-origin 킬스위치 (chrome/browser/predictors) | ✅ 09-21 | ✅ #496 | ✅ `04c9cdc` | ✅ 127/127 | ✅ 8450670 | ⏳ | ✅ #506 | ⬜ | 6 — **업로드 09-23** (chikamune@ 1차 · CC amoseui@, OSSCA #496) |
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ✅ #494 | ✅ `5b16bc9` | ✅ 198/198 | ✅ 8449690 | ⏳ | ✅ #503 | ⬜ | 6 — **업로드 09-23** (PS1, tmathmeyer@ 1차 · CC amoseui@). +1 오면 두 번째 media OWNER (XS) |
| [495852034](https://crbug.com/495852034) B `kRejectInvalidChildRegions` (viz hit_test) | ✅ 09-21 | ✅ #495 | ✅ `2480f86` | ✅ 19/19 | ✅ 8449710 | ⏳ | ✅ #504 | ⬜ | 6 — **업로드 09-23** (PS1, jonross@ 1차 · CC amoseui@). +1 오면 두 번째 viz OWNER (XS) |
| [524822746](https://crbug.com/524822746) E `kValidatePromiseImageFormat` (viz display_embedder) | ✅ 09-21 | ✅ #497 | ✅ `0738586` | ✅ 19/19 | ✅ 8450690 | ⏳ | ✅ #507 | ⬜ | 6 — **업로드 09-23** (kylechar@ 1차 · CC amoseui@, OSSCA #497) (XS) |
| (자체 발굴) C gaia 패스키 URL 플래그 (google_apis/gaia) | ✅ 09-21 | ✅ #498 | ✅ `16e163c` | ✅ 20/20 | ✅ 8447532 | ⏳ | ✅ #508 | ⬜ | 6 — **업로드 09-23** (alexilin@ 1차 · CC amoseui@, OSSCA #498) (XS) |
