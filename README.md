...
| [380105415](https://crbug.com/380105415) LCPP initiator-origin 킬스위치 (chrome/browser/predictors) | ✅ 09-21 | ✅ #496 | ✅ `04c9cdc` | ✅ 127/127 | ✅ 8450670 | ⏳ | ✅ #506 머지 | ⬜ | 6 — chikamune@ +1 뒤 nit(09-25 13:28 KST): `IsValidInitiatorOrigin()` 을 `!opaque() && IsURLValidForLcpp(GetURL())` 로 단순화 → **PS2 로컬 완료**(main `bed8289` 로 옮김, 3스텝 19초 빌드, LCPP 127/127, presubmit ✓). 업로드 허가 대기 · yyanagisawa@ 리뷰 대기 |
