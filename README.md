...
| (자체 발굴) `kResetDecoderForNonIDR` 킬스위치 (media/gpu/mac) | ✅ 09-15 | ✅ #440 | ✅ | 🔄 | ⬜ | ⬜ | ⬜ | ⬜ | 4 — **Mac** 브랜치 `reset-decoder-nonidr-killswitch`(1파일 +1/−10, gn check OK). `media_unittests` 빌드·테스트 대기(러너 `killswitch_test_mac.sh`) |
