...
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ⬜ 초안 | ✅ `5b16bc9` | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | 2/4 — verify-abec 통합 빌드 대기 (XS) |
| [495852034](https://crbug.com/495852034) B `kRejectInvalidChildRegions` (viz hit_test) | ✅ 09-21 | ⬜ 초안 | ✅ `2480f86` | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | 2/4 — verify-abec 통합 빌드 대기 (XS) |
| [524822746](https://crbug.com/524822746) E `kValidatePromiseImageFormat` (viz display_embedder) | ✅ 09-21 | ⬜ 초안 | ✅ `0738586` | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | 2/4 — verify-abec 통합 빌드 대기 (XS) |
| (자체 발굴) C gaia 패스키 URL 플래그 (google_apis/gaia) | ✅ 09-21 | ⬜ 초안 | ✅ `16e163c` | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | 2/4 — verify-abec 통합 빌드 대기 (XS) |
