...
- **두 머신 운용 규칙 (09-15)**: 어느 머신에서 무엇을 돌리는지는 **이 저장소(README 보드 + `steps/*/STATUS.md` + `issues/*.md`)가 유일한 공유 상태**다. 착수·빌드 시작·검증 결과·커밋 해시가 생길 때마다 **바로 커밋하고 push**한다(`git pull --rebase` 먼저). 보드의 «지금 어디» 칸에 머신 이름(Mac/리눅스)을 적는다
  ...
  - 리눅스 (09-23): ChromeOS 후보 V~Z 담당(1단계 STATUS 끝 절, 리눅스 재확인·정정 포함). `out/cros` 첫 빌드 러너 `cros_base_linux.sh` — **09-23 15:12 KST 사용자 tmux `cros`에서 시작**(BASE `49ad5ff15f011`), 진행은 `logs/cros_base_done.marker`
...
| 40831207 (CL A) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 8 — #378 머지(09-05). **#342는 멘토(amoseui)가 09-21 닫음** — CL B/C 보류 상태로 종결 |
| 40831207 (CL B·C) | ➖ | ➖ | ⏸ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ✗ — CL B 보류(batching mode 8291668 방향 충돌, 09-07 문의 무응답) 상태에서 #342가 09-21 멘토에 의해 닫힘. 재개하려면 새 이슈 |
| 40681786 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 🔄 | 8 — **CL 8351543 머지(09-09 14:47, `3f65cb3afb2d1`)**. `status: merged` PR **#415**(`Closes #400`) 제출, 머지 대기 |
| 545843242 | ✅ | ✅ | ✅ | ✅ | ✅ 8449730 | ✅ 머지 09-23 | ✅ #505 | 🔄 | 8 — 후속 WPT 수정 **8449730 머지 09-23 23:33 KST** (`6aba99912170a`, smcgruer@·nikifork@ +1), upstream WPT #62900 반영. merged PR **#512**(09-24) · #401 닫기 대기 |
...
| (자체 발굴) quota 테스트 클럭 댕글링 | ✅ 09-10 | ✅ #421 | ✅ | ✅ | ✅ 8377022 | ✅ 머지 09-23 | ✅ #424 | 🔄 | 8 — **머지 09-23 07:56 KST** (`b8c9f8a3cd8d9`). merged PR **#493**(09-23 머지) · **#421 닫음(09-23 13:00)** |
| (자체 발굴) quota 만료 M148 153곳 | ✅ 09-09 | ✅ #422 | ✅ | ✅ 313/313 | ✅ 8377550 | ✅ 머지 09-21 | ✅ #425 | 🔄 | 8 — **머지 09-21** (`2d9fea1150857`, stevebe@ CQ). merged PR **#487**(09-23 머지) · #422 닫음(09-22) |
...
| 40176243 (sql ColumnTime) CL 2 net/extras | ✅ 09-15 | ✅ #416 | ✅ `a3c7d4d` | ✅ 27/27 | ✅ 8410045 | ✅ 머지 09-21 | ✅ #452 | 🔄 | 8 — CL 2 **머지 09-21** (`59647e287088b`). merged PR **#486**(09-23 머지). CL 3~5 미착수 |
...
| (자체 발굴) WebAuthn iCloud Keychain 플래그 3개 (device/fido) | ✅ 09-15 | ✅ #441 | ✅ 09-16 | ✅ 09-16 | ✅ 8412192 | ✅ 머지 09-24 | ✅ #450 | ⬜ | 8 — **머지 09-24 03:52 KST** (`01509d69cad23`, nsatragno@ CQ 재시도). merged PR **#520**(09-24) · #441 닫기 대기 |
...
| [41161335](https://crbug.com/41161335) frozen-frames 플래그 (media/base + blink platform/media) | ✅ 09-18 | ✅ #465 | ✅ `654824f` | ✅ 78/78 | ✅ 8423128 | ✅ 머지 09-24 | ✅ #476 | ⬜ | 8 — **머지 09-24 02:49 KST** (`7a3cf7f869ea4`). merged PR **#516**(09-24) · **#465 닫음(09-24)** |
...
| [496016840](https://crbug.com/496016840) G `kWebviewScriptFileOriginCheck` (extensions webview) | ✅ 09-23 | ✅ #517 | ✅ `871237c` | ✅ CF 2/2 | ✅ 8453023 | ⏳ | ⬜ | ⬜ | 6 — **업로드 09-24** (mcnee@ 1차 · CC amoseui@). 이전: browser_tests 4h31m ✓. 원 CL 테스트(WebUIWebViewBrowserTest)는 파일 전체가 `#if !IS_MAC` 라 Mac 에서 못 돎 → 같은 경로의 ControlledFrameApiTest.ExecuteScript·ControlledFrameWptBrowserTest add_content_scripts 2/2. presubmit ✓. 업로드 허가 대기, 리뷰어 mcnee@ (guest_view OWNER, 원 작성자) (XS) |
| [489205993](https://crbug.com/489205993) H `kBackgroundActorTaskPopupsOpenInBackground` (chrome/ui actor) | ✅ 09-23 | ✅ #518 | ✅ | ✅ 6/6 | ✅ 8453762 | ⏳ | ⬜ | ⬜ | 6 — **업로드 09-24** (tluk@ 1차 · CC amoseui@, +1 뒤 mcnee@). 이전: ActorAttemptLoginToolFederatedTest.* 첫 배치 5/6(팝업 포커스 검사 1개 실패) → 단독 3/3·배치 재실행 6/6 ×2 → 포커스 플레이크. presubmit ✓. 업로드 허가 대기, 리뷰어 tluk@ (chrome/browser/ui OWNER, 코드 이동 작성자) (XS) |
| [380105415](https://crbug.com/380105415) LCPP initiator-origin 킬스위치 (chrome/browser/predictors) | ✅ 09-21 | ✅ #496 | ✅ `04c9cdc` | ✅ 127/127 | ✅ 8450670 | ⏳ | ✅ #506 머지 | ⬜ | 6 — **업로드 09-23** (chikamune@ 1차 · CC amoseui@, OSSCA #496) |
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ✅ #494 | ✅ `5b16bc9` | ✅ 198/198 | ✅ 8449690 | ⏳ | ✅ #503 머지 | ⬜ | 6 — tmathmeyer@ **+1**(09-24) → 두 번째 media OWNER 추가 필요(dalecurtis@, 원 수정 작성자) · 기록 PR #503 머지 |
| [495852034](https://crbug.com/495852034) B `kRejectInvalidChildRegions` (viz hit_test) | ✅ 09-21 | ✅ #495 | ✅ `2480f86` | ✅ 19/19 | ✅ 8449710 | ⏳ | ✅ #504 머지 | ⬜ | 6 — **업로드 09-23** (PS1, jonross@ 1차 · CC amoseui@). +1 오면 두 번째 viz OWNER (XS) |
| [524822746](https://crbug.com/524822746) E `kValidatePromiseImageFormat` (viz display_embedder) | ✅ 09-21 | ✅ #497 | ✅ `0738586` | ✅ 19/19 | ✅ 8450690 | ✅ 머지 09-24 | ✅ #507 | ⬜ | 8 — **머지 09-24 03:19 KST** (`faf118a8c89fb`, kylechar@ CQ 재시도). merged PR **#522**(09-24) · #497 닫기 대기 |
| (자체 발굴) C gaia 패스키 URL 플래그 (google_apis/gaia) | ✅ 09-21 | ✅ #498 | ✅ `16e163c` | ✅ 20/20 | ✅ 8447532 | ✅ 머지 09-24 | ✅ #508 | ⬜ | 8 — **머지 09-24 03:49 KST** (`ec8311ae05c34`, alexilin@ CQ). merged PR **#521**(09-24) · #498 닫기 대기 |
...
| (자체 발굴) extension_service 강제설치 우회 (extensions) | ✅ 09-15 | ✅ #443 | ✅ | ✅ 191/191 | ✅ 8410065 | ⏳ | ⬜ | ⬜ | 6 — **PS2/PS3 업로드 09-23 (Mac)**: 테스트를 정책 provider 경로로 재작성 + 관리 기기 표시, 193/193. 리뷰어 답글 대기. 이전: **리눅스** 09-15 **CL 8410065** PS1 업로드(rdevlin.cronin@·andreaorru@, CC nicolaso@). 커밋 `455e826cf4aa7`. 1단계: 블록만 지우면 기존 테스트 실패(의존 증명) ✓ · 2단계: 테스트를 `OnExternalExtensionUpdateUrlFound` 경로로 재작성 5/5 ✓ · `ExtensionServiceTest.*` **191/191** ✓ — 검증 완료, 리베이스·업로드 승인 대기 (`issues/extension-service-force-install-workaround.md`) |
...
| [545843242](https://crbug.com/545843242) | Link 헤더 exactly-one 검증 (545645933 쌍둥이, OSSCA #401) | CL 8349386 PS1(09-04) → 8280660과 충돌 → 09-05 리베이스 → 09-06 빌드·테스트 통과(42/42) → **PS2 업로드+설명 답글(09-07, 커밋 `4aa401c79f25c`)** → 리뷰어가 스펙 근거 없음 지적 → **abandon(09-22, PR #490)** → 후속 WPT 수정 [8449730](https://crrev.com/c/8449730) 업로드(09-23) · 기록 PR #386 머지(09-06) |
