...
| (자체 발굴) WebAuthn iCloud Keychain 플래그 3개 (device/fido) | ✅ 09-15 | ✅ #441 | ✅ 09-16 | ✅ 09-16 | ✅ 8412192 | ✅ +1×2 | ✅ #450 | ⬜ | 6 — nsatragno@ CQ+2(09-23 21:33 KST) → **CQ 실패** android-desktop-x64-rel `GlicInvokeBrowserTest.*` 2개 — 같은 날 다른 CL 빌드 10건에서도 실패(무관) → 재시도 요청 댓글(사용자) |
...
| [496016840](https://crbug.com/496016840) G `kWebviewScriptFileOriginCheck` (extensions webview) | ✅ 09-23 | ✅ #517 | ✅ `871237c` | 🔄 browser_tests | ⬜ | ⬜ | ⬜ | ⬜ | 4 — verify-gh 빌드 중(Mac) (XS) |
| [489205993](https://crbug.com/489205993) H `kBackgroundActorTaskPopupsOpenInBackground` (chrome/ui actor) | ✅ 09-23 | ✅ #518 | ✅ | 🔄 browser_tests | ⬜ | ⬜ | ⬜ | ⬜ | 4 — verify-gh 빌드 중(Mac) (XS) |
...
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ✅ #494 | ✅ `5b16bc9` | ✅ 198/198 | ✅ 8449690 | ⏳ | ✅ #503 머지 | ⬜ | 6 — **업로드 09-23** (PS1, tmathmeyer@ 1차 · CC amoseui@). +1 오면 두 번째 media OWNER (XS) |
...
| [524822746](https://crbug.com/524822746) E `kValidatePromiseImageFormat` (viz display_embedder) | ✅ 09-21 | ✅ #497 | ✅ `0738586` | ✅ 19/19 | ✅ 8450690 | ⏳ | ✅ #507 | ⬜ | 6 — vasilyt@ CQ+2 → **CQ 실패(09-24 02:47 KST)** gpu-fyi-cq-android-arm64: Pixel_Video_Context_Loss_VP9(frankel)·ExpectedColor_MediaRecorderFromVideoElement(Pixel 6) — 각각 한 기기에서만 실패, without patch 통과, 플래그는 원래 기본 켜짐·필드트라이얼 없음 → 플레이크 판단. 재시도 요청 댓글(사용자) |
| (자체 발굴) C gaia 패스키 URL 플래그 (google_apis/gaia) | ✅ 09-21 | ✅ #498 | ✅ `16e163c` | ✅ 20/20 | ✅ 8447532 | ⏳ | ✅ #508 | ⬜ | 6 — alexilin@·nsatragno@ **+1 둘** → **제출 요청 댓글 09-24 02:09 KST**(사용자), attention 두 사람. CQ+2 대기 · 기록 PR #508 머지 |
