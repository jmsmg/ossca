...
| [467555325](https://crbug.com/467555325) J `kAccurateVideoFrameConverterColorSpace` (media/base) | ✅ 09-24 | ✅ #524 | ✅ `d59604f` | ✅ 1460/1460 | ✅ 8457722 | ⏳ | ⬜ | ⬜ | 6 — dalecurtis@ **+1** → tmathmeyer@ 추가·댓글(09-25, 사용자) · 기록 PR **#529** |
...
| [496016840](https://crbug.com/496016840) G `kWebviewScriptFileOriginCheck` (extensions webview) | ✅ 09-23 | ✅ #517 | ✅ `871237c` | ✅ CF 2/2 | ✅ 8453023 | ⏳ | ⬜ | ⬜ | 6 — mcnee@·creis@ **+1 둘** → **제출 요청 댓글 09-25 02:30 KST**(사용자) · 기록 PR **#525** |
...
| [380105415](https://crbug.com/380105415) LCPP initiator-origin 킬스위치 (chrome/browser/predictors) | ✅ 09-21 | ✅ #496 | ✅ `04c9cdc` | ✅ 127/127 | ✅ 8450670 | ⏳ | ✅ #506 머지 | ⬜ | 6 — chikamune@ **+1** → yyanagisawa@ 추가·댓글(09-25, 사용자) |
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ✅ #494 | ✅ `5b16bc9` | ✅ 198/198 | ✅ 8449690 | ✅ 머지 09-25 | ✅ #503 머지 | ⬜ | 8 — **머지 09-25 02:28 KST** (`5c1ab551fbab4`, dalecurtis@ CQ 재시도). merged PR 로컬 준비 · #494 닫기 대기 |
| [495852034](https://crbug.com/495852034) B `kRejectInvalidChildRegions` (viz hit_test) | ✅ 09-21 | ✅ #495 | ✅ `2480f86` | ✅ 19/19 | ✅ 8449710 | ⏳ | ✅ #504 머지 | ⬜ | 6 — jonross@·kylechar@ **+1 둘**, kylechar@ **CQ+2 (09-25 02:32 KST)** CQ 진행 중 |
