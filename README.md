...
| 40176243 (sql ColumnTime) CL 2 net/extras | ✅ 09-15 | ✅ #416 | ✅ `a3c7d4d` | ✅ 27/27 | ✅ 8410045 | ⏳ | ✅ #452 | ⬜ | 6 — **CL 8410045**(09-15) nidhijaju@ +1, ricea@ 대기. 기록 PR **#452**(09-17). #416 코멘트 허가 대기 |
| (자체 발굴) 만료 M144 signin 3곳+enum | ✅ 09-15 | ✅ #439 | ✅ `bb98018` | ✅ 95/95·26/26 | ✅ 8409786 | ⏳ | ✅ #451 | ⬜ | 6 — **CL 8409786**(09-15) alexilin@·gab@ **+1 둘**, 제출 요청 대기. 기록 PR **#451**(09-17). #439 코멘트 허가 대기 |
| (자체 발굴) `kResetDecoderForNonIDR` 킬스위치 (media/gpu/mac) | ✅ 09-15 | ✅ #440 | ✅ | ✅ 8/8 | ✅ 8410466 | ⏳ | ✅ #453 | ⬜ | 6 — **CL 8410466**(09-15) eugene@·dalecurtis@ **+1 둘**, 제출 요청 대기. 기록 PR **#453**(09-17). #440 코멘트 허가 대기 |
| (자체 발굴) WebAuthn iCloud Keychain 플래그 3개 (device/fido) | ✅ 09-15 | ✅ #441 | ✅ 09-16 | ✅ 09-16 | ✅ 8412192 | ⬜ | ✅ #450 | ⬜ | 6 리뷰 대기 — **Mac** 09-16 **CL 8412192** PS3 (derinel@·nsatragno@). 7단계 기록 PR 허가 대기 (S) |
