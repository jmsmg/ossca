...
| [496016840](https://crbug.com/496016840) G `kWebviewScriptFileOriginCheck` (extensions webview) | ✅ 09-23 | ✅ #517 | ✅ `871237c` | ✅ CF 2/2 | ✅ 8453023 | ✅ 머지 09-25 | ⬜ | ⬜ | 8 — **머지 09-25 11:54 KST** (`d22b445d714c3`, mcnee@ CQ). merged PR **#543** · **#517 닫음** |
| [489205993](https://crbug.com/489205993) H `kBackgroundActorTaskPopupsOpenInBackground` (chrome/ui actor) | ✅ 09-23 | ✅ #518 | ✅ | ✅ 6/6 | ✅ 8453762 | ⏳ | ⬜ | ⬜ | 6 — tluk@·mcnee@ **+1 둘** → **제출 요청 09-25 11:58**(사용자) · 기록 PR **#527 머지** |
...
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ✅ #494 | ✅ `5b16bc9` | ✅ 198/198 | ✅ 8449690 | ✅ 머지 09-25 | ✅ #503 머지 | ⬜ | 8 — **머지 09-25 02:28 KST** (`5c1ab551fbab4`, dalecurtis@ CQ 재시도). merged PR **#541** · **#494 닫음** |
| [495852034](https://crbug.com/495852034) B `kRejectInvalidChildRegions` (viz hit_test) | ✅ 09-21 | ✅ #495 | ✅ `2480f86` | ✅ 19/19 | ✅ 8449710 | ✅ 머지 09-25 | ✅ #504 머지 | ⬜ | 8 — **머지 09-25 04:22 KST** (`425de4fbabe45`, kylechar@ CQ). merged PR **#542** · **#495 닫음** |
