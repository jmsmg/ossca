...
| [379418979](https://crbug.com/379418979) D `kStrictFFmpegCodecs` (media/ffmpeg) | ✅ 09-24 | ✅ #523 | ✅ `6887bba` | ✅ 219/219 | ✅ 8457502 | ⏳ | ⬜ | ⬜ | 6 — tmathmeyer@ **+1** → **dalecurtis@ 추가·댓글 09-25 11:59**(사용자) · 기록 PR **#528 머지** |
| [467555325](https://crbug.com/467555325) J `kAccurateVideoFrameConverterColorSpace` (media/base) | ✅ 09-24 | ✅ #524 | ✅ `d59604f` | ✅ 1460/1460 | ✅ 8457722 | ⏳ | ⬜ | ⬜ | 6 — dalecurtis@·tmathmeyer@ **+1 둘** → **제출 요청 09-25 11:59**(사용자) · 기록 PR **#529 머지** |
...
| [496016840](https://crbug.com/496016840) G `kWebviewScriptFileOriginCheck` (extensions webview) | ✅ 09-23 | ✅ #517 | ✅ `871237c` | ✅ CF 2/2 | ✅ 8453023 | ✅ 머지 09-25 | ⬜ | ⬜ | 8 — **머지 09-25 11:54 KST** (`d22b445d714c3`, mcnee@ CQ). merged PR **#543 머지** · **#517 닫음** |
| [489205993](https://crbug.com/489205993) H `kBackgroundActorTaskPopupsOpenInBackground` (chrome/ui actor) | ✅ 09-23 | ✅ #518 | ✅ | ✅ 6/6 | ✅ 8453762 | ⏳ | ⬜ | ⬜ | 6 — tluk@ CQ+2 → **CQ 실패(09-25 14:37 KST)** win_chromium_compile_dbg_ng **Infra Failure** `bot_update` (코드 무관) → **재시도 요청 댓글 09-25 19:34**(사용자) · 기록 PR **#527 머지** |
| [380105415](https://crbug.com/380105415) LCPP initiator-origin 킬스위치 (chrome/browser/predictors) | ✅ 09-21 | ✅ #496 | ✅ `04c9cdc` | ✅ 127/127 | ✅ 8450670 | ⏳ | ✅ #506 머지 | ⬜ | 6 — chikamune@ +1 뒤 nit(09-25 13:28 KST): `IsValidInitiatorOrigin()` 을 `!opaque() && IsURLValidForLcpp(GetURL())` 로 단순화 → **PS2 업로드 09-25**(main `bed8289` 로 옮김, LCPP 127/127, presubmit ✓). **chikamune@ 스레드 답글·resolve 09-25 19:40**(사용자), attention chikamune@·yyanagisawa@ · yyanagisawa@ 리뷰 대기 |
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ✅ #494 | ✅ `5b16bc9` | ✅ 198/198 | ✅ 8449690 | ✅ 머지 09-25 | ✅ #503 머지 | ⬜ | 8 — **머지 09-25 02:28 KST** (`5c1ab551fbab4`, dalecurtis@ CQ 재시도). merged PR **#541 머지** · **#494 닫음** |
| [495852034](https://crbug.com/495852034) B `kRejectInvalidChildRegions` (viz hit_test) | ✅ 09-21 | ✅ #495 | ✅ `2480f86` | ✅ 19/19 | ✅ 8449710 | ✅ 머지 09-25 | ✅ #504 머지 | ⬜ | 8 — **머지 09-25 04:22 KST** (`425de4fbabe45`, kylechar@ CQ). merged PR **#542 머지** · **#495 닫음** |
...
| (자체 발굴) extension_service 강제설치 우회 (extensions) | ✅ 09-15 | ✅ #443 | ✅ | ✅ 191/191 | ✅ 8410065 | ⏳ | ✅ #549 | ⬜ | 6 — rdevlin.cronin@ **+1**(«LGTM», 09-25) → **andreaorru@ 요청 댓글 09-25 12:08**(사용자). rdevlin.cronin@ 09-29 까지 부재 |
