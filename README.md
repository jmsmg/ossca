...
| (자체 발굴) `kResetDecoderForNonIDR` 킬스위치 (media/gpu/mac) | ✅ 09-15 | ✅ #440 | ✅ | ✅ 78/78 | ✅ 8410466 | ✅ 머지 09-17 | ✅ #453 | 🔄 | 8 — **머지 09-17** (`0a61d4d13c9e4`, eugene@ CQ). 기록 PR #453 머지. merged PR **#461**(`Closes #440`) 제출 09-18 |
...
| [432367602](https://crbug.com/432367602) dropped-frame 플래그 (media/base + blink mediastream) | ✅ 09-18 | ✅ #464 | ✅ `ee435a2` | ✅ 14/14 | ✅ 8429522 | ⏳ | ⬜ | ⬜ | 6 — **Mac** 09-18 **CL 8429522** PS1 (kron@·mfoltz@). #464 코멘트·기록 PR 허가 대기 (S) |
| [41161335](https://crbug.com/41161335) frozen-frames 플래그 (media/base + blink platform/media) | ✅ 09-18 | ✅ #465 | ✅ `654824f` | ✅ 78/78 | ⬜ | ⬜ | ⬜ | ⬜ | 5 — **Mac** blink_unittests 4h35m ✓(09-19). 업로드 허가 대기 (리뷰어 dalecurtis@·tmathmeyer@) (S) |
