...
| [379418979](https://crbug.com/379418979) D `kStrictFFmpegCodecs` (media/ffmpeg) | ✅ 09-24 | ✅ #523 | ✅ `6887bba` | ✅ 219/219 | ✅ 8457502 | ⏳ | ⬜ | ⬜ | 6 — **업로드 09-24** (tmathmeyer@ 1차 · CC amoseui@) (XS) |
| [467555325](https://crbug.com/467555325) J `kAccurateVideoFrameConverterColorSpace` (media/base) | ✅ 09-24 | ✅ #524 | ✅ `d59604f` | ✅ 1460/1460 | ✅ 8457722 | ⏳ | ⬜ | ⬜ | 6 — **업로드 09-24** (dalecurtis@ 1차 · CC amoseui@). 기록 PR 예약(14:43) (S) |
...
| [489205993](https://crbug.com/489205993) H `kBackgroundActorTaskPopupsOpenInBackground` (chrome/ui actor) | ✅ 09-23 | ✅ #518 | ✅ | ✅ 6/6 | ✅ 8453762 | ⏳ | ⬜ | ⬜ | 6 — tluk@ **+1**(09-24) → **mcnee@ 추가·댓글 09-24 13:56 KST**(사용자), attention mcnee@ · 기록 PR 미제출 |
...
5. **try-job 추천** — smcgruer@ 09-07 요청 무응답(17일, 09-24 종결) → 멘토 amoseui@ 에게 요청 예정
