...
| [489205993](https://crbug.com/489205993) H `kBackgroundActorTaskPopupsOpenInBackground` (chrome/ui actor) | ✅ 09-23 | ✅ #518 | ✅ | ✅ 6/6 | ✅ 8453762 | ⏳ | ⬜ | ⬜ | 6 — tluk@ CQ+2 → **CQ 실패(09-25 14:37 KST)** win_chromium_compile_dbg_ng **Infra Failure** `bot_update` (코드 무관) → 재시도 요청 댓글(사용자) · 기록 PR **#527 머지** |
| [380105415](https://crbug.com/380105415) LCPP initiator-origin 킬스위치 (chrome/browser/predictors) | ✅ 09-21 | ✅ #496 | ✅ `04c9cdc` | ✅ 127/127 | ✅ 8450670 | ⏳ | ✅ #506 머지 | ⬜ | 6 — chikamune@ +1 뒤 nit(09-25 13:28 KST): `IsValidInitiatorOrigin()` 을 `!opaque() && IsURLValidForLcpp(GetURL())` 로 단순화 → **PS2 업로드 09-25**(main `bed8289` 로 옮김, LCPP 127/127, presubmit ✓). chikamune@ 스레드 답글(사용자) · yyanagisawa@ 리뷰 대기 |
