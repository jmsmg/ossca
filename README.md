...
| [379418979](https://crbug.com/379418979) D `kStrictFFmpegCodecs` (media/ffmpeg) | ✅ 09-24 | ✅ #523 | ✅ `6887bba` | ✅ 219/219 | ✅ 8457502 | ⏳ | ⬜ | ⬜ | 6 — tmathmeyer@ **+1** → **dalecurtis@ 추가·댓글 09-25 11:59**(사용자) · 기록 PR **#528** |
| [467555325](https://crbug.com/467555325) J `kAccurateVideoFrameConverterColorSpace` (media/base) | ✅ 09-24 | ✅ #524 | ✅ `d59604f` | ✅ 1460/1460 | ✅ 8457722 | ⏳ | ⬜ | ⬜ | 6 — dalecurtis@·tmathmeyer@ **+1 둘** → **제출 요청 09-25 11:59**(사용자) · 기록 PR **#529** |
...
| [496016840](https://crbug.com/496016840) G `kWebviewScriptFileOriginCheck` (extensions webview) | ✅ 09-23 | ✅ #517 | ✅ `871237c` | ✅ CF 2/2 | ✅ 8453023 | ✅ 머지 09-25 | ⬜ | ⬜ | 8 — **머지 09-25 11:54 KST** (`d22b445d714c3`, mcnee@ CQ). merged PR **#543** · #517 닫기 대기 |
| [489205993](https://crbug.com/489205993) H `kBackgroundActorTaskPopupsOpenInBackground` (chrome/ui actor) | ✅ 09-23 | ✅ #518 | ✅ | ✅ 6/6 | ✅ 8453762 | ⏳ | ⬜ | ⬜ | 6 — tluk@·mcnee@ **+1 둘** → **제출 요청 09-25 11:58**(사용자) · 기록 PR **#527** |
...
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ✅ #494 | ✅ `5b16bc9` | ✅ 198/198 | ✅ 8449690 | ✅ 머지 09-25 | ✅ #503 머지 | ⬜ | 8 — **머지 09-25 02:28 KST** (`5c1ab551fbab4`, dalecurtis@ CQ 재시도). merged PR **#541** · #494 닫기 대기 |
| [495852034](https://crbug.com/495852034) B `kRejectInvalidChildRegions` (viz hit_test) | ✅ 09-21 | ✅ #495 | ✅ `2480f86` | ✅ 19/19 | ✅ 8449710 | ✅ 머지 09-25 | ✅ #504 머지 | ⬜ | 8 — **머지 09-25 04:22 KST** (`425de4fbabe45`, kylechar@ CQ). merged PR **#542** · #495 닫기 대기 |
...
| (자체 발굴) extension_service 강제설치 우회 (extensions) | ✅ 09-15 | ✅ #443 | ✅ | ✅ 191/191 | ✅ 8410065 | ⏳ | ⬜ | ⬜ | 6 — rdevlin.cronin@ **+1**(«LGTM», 09-25) → andreaorru@ 두 번째 +1 필요, 핑(사용자) |
