...
| [496016840](https://crbug.com/496016840) G `kWebviewScriptFileOriginCheck` (extensions webview) | ✅ 09-23 | ✅ #517 | ✅ `871237c` | ✅ CF 2/2 | ⬜ | ⬜ | ⬜ | ⬜ | 4 — browser_tests 4h31m ✓. 원 CL 테스트(WebUIWebViewBrowserTest)는 파일 전체가 `#if !IS_MAC` 라 Mac 에서 못 돎 → 같은 경로의 ControlledFrameApiTest.ExecuteScript·ControlledFrameWptBrowserTest add_content_scripts 2/2. presubmit ✓. 업로드 허가 대기, 리뷰어 mcnee@ (guest_view OWNER, 원 작성자) (XS) |
| [489205993](https://crbug.com/489205993) H `kBackgroundActorTaskPopupsOpenInBackground` (chrome/ui actor) | ✅ 09-23 | ✅ #518 | ✅ | ✅ 6/6 | ⬜ | ⬜ | ⬜ | ⬜ | 4 — ActorAttemptLoginToolFederatedTest.* 첫 배치 5/6(팝업 포커스 검사 1개 실패) → 단독 3/3·배치 재실행 6/6 ×2 → 포커스 플레이크. presubmit ✓. 업로드 허가 대기, 리뷰어 tluk@ (chrome/browser/ui OWNER, 코드 이동 작성자) (XS) |
