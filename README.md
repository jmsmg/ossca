...
- **두 머신 운용 규칙 (09-15)**: 어느 머신에서 무엇을 돌리는지는 **이 저장소(README 보드 + `steps/*/STATUS.md` + `issues/*.md`)가 유일한 공유 상태**다. 착수·빌드 시작·검증 결과·커밋 해시가 생길 때마다 **바로 커밋하고 push**한다(`git pull --rebase` 먼저). 보드의 «지금 어디» 칸에 머신 이름(Mac/리눅스)을 적는다
  ...
  - 리눅스 (09-23): ChromeOS 후보 V~Z 담당(1단계 STATUS 끝 절, 리눅스 재확인·정정 포함). `out/cros` 첫 빌드 러너 `cros_base_linux.sh` — **09-24 19:03 KST 베이스 빌드·대조군 완료**(BASE `49ad5ff15f011`, Z 7/7·V 46/46·X+Y 33/33). 초안 5건 `steps/2-ossca-issue/drafts/`(Y 보류 권장)
...
| 545843242 | ✅ | ✅ | ✅ | ✅ | ✅ 8449730 | ✅ 머지 09-23 | ✅ #505 | 🔄 | 8 — 후속 WPT 수정 **8449730 머지 09-23 23:33 KST** (`6aba99912170a`, smcgruer@·nikifork@ +1), upstream WPT #62900 반영. merged PR **#512 머지** · #401 닫기 대기 |
...
| (자체 발굴) WebAuthn iCloud Keychain 플래그 3개 (device/fido) | ✅ 09-15 | ✅ #441 | ✅ 09-16 | ✅ 09-16 | ✅ 8412192 | ✅ 머지 09-24 | ✅ #450 | ⬜ | 8 — **머지 09-24 03:52 KST** (`01509d69cad23`, nsatragno@ CQ 재시도). merged PR **#520 머지** · **#441 닫음** |
...
| [379418979](https://crbug.com/379418979) D `kStrictFFmpegCodecs` (media/ffmpeg) | ✅ 09-24 | ✅ #523 | ✅ `6887bba` | ✅ 219/219 | ✅ 8457502 | ⏳ | ⬜ | ⬜ | 6 — **업로드 09-24** (tmathmeyer@ 1차 · CC amoseui@) (XS) · 기록 PR **#528** |
| [467555325](https://crbug.com/467555325) J `kAccurateVideoFrameConverterColorSpace` (media/base) | ✅ 09-24 | ✅ #524 | ✅ `d59604f` | ✅ 1460/1460 | ✅ 8457722 | ⏳ | ⬜ | ⬜ | 6 — **업로드 09-24** (dalecurtis@ 1차 · CC amoseui@). 기록 PR **#529** (S) |
| [335524391](https://crbug.com/335524391) K `Navigation.Prefetch.*BodySize` 만료 히스토그램 (chrome/browser/predictors) | ✅ 09-24 | ✅ #536 | ✅ | ✅ 114/114 | ✅ 8461862 | ⏳ | ⬜ | ⬜ | 6 — **업로드 09-24** (ricea@ 1차 · CC amoseui@, +1 뒤 chikamune@). 범위는 TODO 의 2개 · 기록 PR **#537** |
| [496016840](https://crbug.com/496016840) G `kWebviewScriptFileOriginCheck` (extensions webview) | ✅ 09-23 | ✅ #517 | ✅ `871237c` | ✅ CF 2/2 | ✅ 8453023 | ⏳ | ⬜ | ⬜ | 6 — mcnee@ **+1**(«LGTM», 09-24) → **creis@ 추가·댓글 09-24 13:56 KST**(사용자), attention creis@ · 기록 PR **#525** |
| [489205993](https://crbug.com/489205993) H `kBackgroundActorTaskPopupsOpenInBackground` (chrome/ui actor) | ✅ 09-23 | ✅ #518 | ✅ | ✅ 6/6 | ✅ 8453762 | ⏳ | ⬜ | ⬜ | 6 — tluk@ **+1**(09-24) → **mcnee@ 추가·댓글 09-24 13:56 KST**(사용자), attention mcnee@ · 기록 PR **#527** |
...
| [486351442](https://crbug.com/486351442) A `kMergeRangesDuringAppend` (media/filters) | ✅ 09-21 | ✅ #494 | ✅ `5b16bc9` | ✅ 198/198 | ✅ 8449690 | ⏳ | ✅ #503 머지 | ⬜ | 6 — tmathmeyer@·dalecurtis@ **+1 둘**, dalecurtis@ CQ+2 → **CQ 실패(09-24 07:30 KST)** gpu-fyi-cq-mac-arm64 WebGL2 conformance 4건(패치 없이 통과, MSE 와 무관) → **재시도 요청 댓글 09-24 13:55 KST**(사용자), attention dalecurtis@ · 기록 PR #503 머지 |
...
5. **try-job 추천** — smcgruer@ 09-07 요청 무응답(17일, 09-24 종결) → 다음 추천인 미정(멘토 제외)
