...
| 545843242 | ✅ | ✅ | ✅ | ✅ | ✅ 8449730 | ✅ 머지 09-23 | ✅ #505 | 🔄 | 8 — 후속 WPT 수정 **8449730 머지 09-23 23:33 KST** (`6aba99912170a`, smcgruer@·nikifork@ +1), upstream WPT #62900 반영. merged PR 로컬 준비(`260924-mark-8449730-merged`) → 허가 대기 · #401 닫기 대기 |
...
| (자체 발굴) WebAuthn iCloud Keychain 플래그 3개 (device/fido) | ✅ 09-15 | ✅ #441 | ✅ 09-16 | ✅ 09-16 | ✅ 8412192 | ✅ +1×2 | ✅ #450 | ⬜ | 6 — derinel@·nsatragno@ **+1 둘**(09-22) → **제출 요청 댓글 09-23 12:14**(사용자), attention derinel@·nsatragno@. CQ+2 대기 |
...
| [41161335](https://crbug.com/41161335) frozen-frames 플래그 (media/base + blink platform/media) | ✅ 09-18 | ✅ #465 | ✅ `654824f` | ✅ 78/78 | ✅ 8423128 | ✅ +1×2 | ✅ #476 | ⬜ | 6 — dalecurtis@·tmathmeyer@ **+1 둘**(09-22) → **제출 요청 댓글 09-23 12:13**(사용자), attention dalecurtis@·tmathmeyer@. CQ+2 대기 |
...
| [524822746](https://crbug.com/524822746) E `kValidatePromiseImageFormat` (viz display_embedder) | ✅ 09-21 | ✅ #497 | ✅ `0738586` | ✅ 19/19 | ✅ 8450690 | ⏳ | ✅ #507 | ⬜ | 6 — kylechar@ **+1**(09-23) → 두 번째 viz OWNER 추가 필요(vasilyt@, 원 CL 리뷰어) · 기록 PR #507 머지 |
| (자체 발굴) C gaia 패스키 URL 플래그 (google_apis/gaia) | ✅ 09-21 | ✅ #498 | ✅ `16e163c` | ✅ 20/20 | ✅ 8447532 | ⏳ | ✅ #508 | ⬜ | 6 — alexilin@·nsatragno@(기능 소유자) **+1 둘**(09-23) → 제출 요청 댓글(사용자) · 기록 PR #508 머지 |
