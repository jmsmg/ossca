...
| [8467023](https://crrev.com/c/8467023) | [shelf] Remove ChromeShelfPrefs::CleanupPreloadPrefs() | S (+0/−64, 3파일) | `Bug: 350769496` (OSSCA #544; `Fixed:`→`Bug:`로 바꿈 — 원인 수정은 2024년, 접근 제한 버그) | diwux@ (1차) · CC amoseui@ | ✅ 업로드 2026-09-25 (리눅스; verify PS1=로컬 ✓) |
| [8460623](https://crrev.com/c/8460623) | [web_apps] Remove the Adobe Express OEM-to-default install migration | M (+0/−225, 7파일) | `Bug: b:314865744` (OSSCA #545) | `chromium-webapps-reviews@` gwsq 풀 · CC amoseui@ | ✅ 업로드 2026-09-25 (리눅스; verify PS1=로컬 ✓) |
