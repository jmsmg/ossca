...
### 결과 (2026-09-24 사용자 확인)

**smcgruer@ 무응답으로 종결** — 발송 09-07 → 09-24 까지 17일 회신 없음(그사이 8449730 리뷰·CQ 는 해 줌, 즉 활동 중인데 메일만 우선순위 밖). 재촉하지 않고 **추천인을 멘토 amoseui@ 로 바꾼다** (머지 22건 시점).
교훈: 개인 메일 부탁은 받는 사람 입장에서 «해도 되고 안 해도 되는 일»이라 쉽게 묻힌다. 멘토처럼 **나를 도울 역할이 있는 사람**에게 먼저 부탁한다.
