...
| 545843242 WPT 수정 (8349386 후속) | `wpt-pmm-multiple-link-headers-545843242` (**Mac**, base 2ca4848) | ✅ 09-22 — 서브테스트 재작성(+14/−11) + expected.txt 삭제. 스펙 ED 원문으로 first-match 재확인. `Bug: 545843242`. 검증은 blink_tests + run_web_tests |
